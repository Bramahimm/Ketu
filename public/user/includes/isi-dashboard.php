            ...
            <?php else: ?>
                <?php while ($row = $result->fetch_assoc()): ?>
                    <div class="bg-white p-4 rounded-xl shadow relative group">
                        <span
                            class="text-xs bg-purple-100 text-purple-600 px-2 py-0.5 rounded-full"><?= htmlspecialchars($row['kategori']) ?></span>
                        ...
                        <div class="flex justify-between text-sm text-gray-500 mt-2">
                            ...
                            <span class="text-red-600 font-medium"><i class="fas fa-flag mr-1"></i>Prioritas
                                <?= htmlspecialchars($row['prioritas']) ?></span>
                        </div>

  ...
  <div class="bg-[#C71585] shadow-lg flex rounded-xl overflow-hidden max-w-4xl w-full">
    ...
    <div class="w-1/2 hidden md:block relative">
      ...
      <div class="absolute bottom-0 left-0 w-full text-black p-4 bg-gray-500 bg-opacity-50">
        <p class="text-white font-semibold">Selamat Datang di Kelola TugasMu</p>
      </div>
    </div>
    <!-- Form Login -->
    <div class="w-full md:w-1/2 p-8 relative">
      ...
      <form action="../src/process/login.php" method="POST" class="space-y-4">
        <div>
          ...
          <div class="flex items-center border rounded-md overflow-hidden">
            ...
            <input type="email" name="email" placeholder="Email" required class="w-full py-2 px-3 focus:outline-none" />
          </div>
        </div>
        <div>
      ...
      <p class="text-sm text-right mt-2"><a href="register.php" class="text-white hover:underline">Belum Punya akun?</a>
      </p>
    </div>
  </div>
</body>

...
function pilihPrioritas(button) {
  ...
  prioritasTerpilih = button.dataset.value;
}

function bukaModal() {
  const modal = document.getElementById("modalTambahTugas");
...
function tutupModal() {
  ...
  document.getElementById("kategoriTugas").value = "";
  document.getElementById("tenggatTugas").value = "";
  document.getElementById("prioritasInput").value = "";
}
